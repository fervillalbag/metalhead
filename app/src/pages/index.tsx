...
const Home: React.FC<HomeIprops> = ({
  ...
  return (
    <>
      {!loading && userAPI?.getUser?.role === "admin" && <div>admin</div>}
      ...
      <Layout>
        <motion.div
          ...
          className="hidden lg:block absolute right-[-160px] top-[-200px] -z-10"
        >
        ...
        <motion.section
          ...
          className="max-w-6xl mx-auto w-11/12 lg:flex items-start py-8 lg:py-16"
        >
